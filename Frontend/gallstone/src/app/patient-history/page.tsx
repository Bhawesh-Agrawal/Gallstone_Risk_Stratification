...
export default function HistoryPage(): React.ReactElement {
  ...
  const [selectedReport, setSelectedReport] = useState<ReportWithUrl | null>(
    null
  );
  ...
  // ---------- FIXED LIST VIEW ----------
  const renderListView = (reports: ReportWithUrl[]) => {
    return (
      <div className="space-y-4">
        {reports.map((report) => (
          <div
            key={report._id}
            className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg hover:ring-2 hover:ring-blue-500 transition-all"
          >
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div className="flex-1">
                {/* --- START OF FIX --- */}
                {/* This container now uses justify-between to separate the left content from the badge */}
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-3">
                  {/* Left side content: Icon, Name, Date */}
                  <div className="flex items-start sm:items-center gap-4">
                    ...
                    >
                      {report.predictionResult.prediction_label ===
                      "Positive" ? (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 text-sm text-gray-600">
                  <p className="flex items-center gap-2">
                    ...
                    <span>{report.patientDetails.address}</span>
                  </p>
                  <p className="flex items-center gap-2">
                  ...
                  <div className="text-xs text-gray-500">
                    <span>
                      ...
                      {(
                        parseFloat(
                          report.predictionResult.probability[
                            "positive (class 0)"
                          ]
                        ) * 100
                      ).toFixed(1)}
              ...
              <div className="flex items-center justify-end">
                <button
                  ...
                  className="bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2 whitespace-nowrap"
                >
  ...
  // ---------- CARD VIEW (UNCHANGED) ----------
  const renderCardView = (reports: ReportWithUrl[]) => {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {reports.map((report) => (
          <div
            key={report._id}
            className="bg-white rounded-xl shadow-md p-4 sm:p-6 flex flex-col justify-between hover:shadow-lg hover:ring-2 hover:ring-blue-500 transition-all"
          >
            <div>
              <div className="flex items-start sm:items-center justify-between mb-4">
                ...
                <span
                  className={`inline-block font-semibold py-1 px-3 rounded-full text-xs sm:text-sm text-center ${
                    report.predictionResult.prediction_label === "Positive"
        ...
        <div className="flex flex-col items-center justify-center text-center text-gray-500 mt-20 mx-4">
          <div className="bg-blue-50 p-8 rounded-2xl max-w-md w-full">
            ...
            <p className="text-gray-600 mb-6">
              Please sign in to view your prediction history and access your
              reports.
            </p>
            <button
        ...
        <div className="flex flex-col items-center justify-center text-center text-gray-500 mt-20 mx-4">
          <div className="bg-gray-50 p-8 rounded-2xl max-w-md w-full">
            ...
            <p className="text-gray-500">
              You have not generated any prediction reports yet. Create your
              first gallstone risk assessment to see it here.
            </p>
          </div>
        </div>
      );
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 sm:mb-10 gap-4">
          <div className="text-left">
            ...
            <p className="text-base sm:text-lg text-gray-600">
              Review your past gallstone risk assessment reports.
            </p>
          </div>
                    ...
                    <div className="space-y-2 text-sm sm:text-base">
                      <p>
                        ...
                        <span className="text-gray-600">
                          {selectedReport.patientDetails.name}
                        </span>
                      </p>
                      <p>
                        <strong className="text-gray-700">Address:</strong>{" "}
                        <span className="text-gray-600">
                          {selectedReport.patientDetails.address}
                        </span>
                      </p>
                      <p>
                        <strong className="text-gray-700">Phone:</strong>{" "}
                        <span className="text-gray-600">
                          {selectedReport.patientDetails.phone}
                        </span>
                      </p>
                    ...
                    <div className="space-y-2 text-sm sm:text-base">
                      ...
                      <p>
                        ...
                        <span className="text-gray-600 ml-2">
                          {(
                            parseFloat(
                              selectedReport.predictionResult.probability[
                                "positive (class 0)"
                              ]
                            ) * 100
                          ).toFixed(2)}
